...
const Producto = () => {
  ...
  const usuarioHaVotado = () => haVotado.includes(usuario.uid)
            ...
            <ContenedorProducto>
                      ...
                      >
                        ...
                        <p>
                          ...
                          <span
                            css={`
                              font-weight: bold;
                              ${esCreador(comentario.usuarioId) && `background-color: var(--naranja);
                              color: white;
                              padding: 2px 5px;
                              font-style: italic;
                              border-radius: 6px;`}
              ...
              <aside>
                ...
                >
                  ...
                  {(usuario && !usuarioHaVotado()) && <Boton onClick={votarProducto}>Votar</Boton>}
                </div>
              </aside>
            </ContenedorProducto>
